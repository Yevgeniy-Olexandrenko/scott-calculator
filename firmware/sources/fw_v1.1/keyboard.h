...
// Keychars
#define KEY_A0_F '?' // SHIFT   A0-? B0-7 C0-8 D0-9
#define KEY_B0_7 '7' //         A1-< B1-4 C1-5 D1-6
#define KEY_C0_8 '8' //         A2-> B2-1 C2-2 D2-3
#define KEY_D0_9 '9' //         A3-; B3-0 C3-: D3-=
#define KEY_A1_E '<' // EE
#define KEY_B1_4 '4'
#define KEY_C1_5 '5'
#define KEY_D1_6 '6'
...
{
	KEY_D3_E, KEY_C3_D, KEY_B3_0, KEY_A3_C,
